...
and KC v17+ URL-prefix support. Exposes 78 admin-API tools as MCP `@tool()`
...
- Fork-only files: `src/middleware/auth.py`, `src/common/logging_filters.py`,
  `NOTICE`, `CHANGELOG.md`, this file, `.github/workflows/{ci,release}.yml`.
