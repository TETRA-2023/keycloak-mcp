...
and KC v17+ URL-prefix support. Exposes 83 admin-API tools as MCP `@tool()`
...
src/
  ...
  tools/
    ...
    realm_smtp_tools.py      — 5 tools (fork-only: SMTP, attribute, action-token, webauthn-passwordless)
