...
and KC v17+ URL-prefix support. Exposes 95 admin-API tools as MCP `@tool()`
...
src/
  ...
  tools/
    ...
    idp_tools.py             — 8 tools (fork-only: IDP list/get/update/create/delete + mapper list/create/delete)
